...
import validarTurno from '../../helper/validateTurnos.js';
...
const MisTurnos = () => {
    ...
    const fechaTurno = '2024-04-20T10:00:00'; 
if (validarTurno(fechaTurno)) {
  
  console.log('Turno agendado correctamente.');
} else {
  console.log('No se pudo agendar el turno debido a errores de validación.');
}

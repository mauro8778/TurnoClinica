...
export const createUserServices = async (params: userDtos & { photo: Express.Multer.File }): Promise<user> => {
    try {
        ...
        const newUser = userModel.create({
            ...
            photo: params.photo.filename, // Solo guardamos el nombre del archivo, no el archivo en sí
        });
